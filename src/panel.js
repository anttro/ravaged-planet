import {PANEL_WIDTH, PANEL_HEIGHT, PANEL_FONT_SIZE, PANEL_BG_COLOR, PANEL_BORDER_COLOR, W, H, FONT_WIDTH} from './constants.js?v=4';
import {drawRect, drawLine} from './gfx.js?v=4';
...
export function drawPanelTitle(ctx, text) {
  ...
  const y = PANEL_Y + 20;
  drawPanelText(ctx, text, x, y, 'white', 'center');
}
