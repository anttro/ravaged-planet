...
export const WEAPON_TYPES = {
  ...
  nuke: {id:'nuke', name:'Nuke', projectile:{type:'normal'}, explosion:{type:'lava', r:100}},
  babyNapalm: {id:'babyNapalm', name:'Napalm', projectile:{type:'normal'}, explosion:{type:'napalm', particles:32}},
  napalm: {id:'napalm', name:'Hot Napalm', projectile:{type:'normal'}, explosion:{type:'napalm', particles:64}},
